...
<header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
    <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3" href="#">Руководитель/Директор ФИО</a>
        ...
        <div class="position-sticky pt-3">
            <ul class="nav flex-column">
                ...
                <li class="nav-item">
                    ...
                    Сведения о количестве обучающихся на курсах
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#">
                    <span data-feather="bar-chart-2"></span>
                    Сведения о рейтинге образовательных программ ДПО
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#">
                    <span data-feather="dollar-sign"></span>
                    сведения о полученных доходах за период
                    </a>
                </li>
                <li class="nav-item">
